...
- [x] **Password reset email error** - OTP expired redirect; fix reset flow
- [x] **Tag deletion not syncing** - Deleted tags still appear; fix event bus/dispatch
- [x] **Status page icon bug** - Wrong icon on "Move to inbox"; use global icon source
- [x] **Status page titles wrong** - All show "All Items"; fix page titles

## PHASE 2: Foundation & Architecture (do these before feature work)

- [x] **Unified filter system** - One item list component accepting filter params (foundation for search, sorting, views)
...
- [x] **Transition rendering bug** - Fix freeze during fade-out; make transition global
